...
source_list = s.split('\n')
command2 = ["/home/sakakibara/opt7/bin/riscv64-unknown-linux-gnu-gcc"]
find_camera = False
...
command2.append("-latomic")
command2.append("-fno-use-cxa-atexit")
command2.append("-o")
command2.append("monte-carlo-ray-tracer_rgccscv")
res2 = subprocess.run(command2, stdout=subprocess.PIPE, stderr=open("err18.txt",'w'))