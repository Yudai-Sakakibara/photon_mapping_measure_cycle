...
def compile_first_half(s):
    ...
    command1 = ["/home/sakakibara/opt/bin/clang", "-I", "/home/sakakibara/opt/gcc/riscv64-elf/11.1/riscv64-unknown-elf/include/", 
                ...
                "-static", "-c", "-emit-llvm", "-std=c++2a", "-std=gnu++17", "-DNDEBUG", s]
    ...
    command7 = ["/home/sakakibara/opt7/bin/riscv64-unknown-linux-gnu-g++", "-c", file_location + filename_nocpp + "_tmp.s", "-o", file_location + filename_nocpp + ".o", "-march=rv64imafd", "-mabi=lp64d", "-DNDEBUG", "-lm", "-lc", "-lgcc", "-std=gnu++17"]
