...
print(command2)
res2 = subprocess.run(command2, stdout=subprocess.PIPE, stderr=open("err49.txt",'w'))
command3 = ["/home/sakakibara/opt7/bin/riscv64-unknown-linux-gnu-objdump", "-S", "monte-carlo-ray-tracer_riscv"]
res3 = subprocess.run(command3, stdout=open("dumpc.txt",'w'), stderr=subprocess.PIPE)