...
def compile_first_half(s):
    ...
    command7 = ["/home/sakakibara/opt7/bin/riscv64-unknown-elf-gcc", "-c", file_location + filename_nocpp + "_tmp.s", "-o", file_location + filename_nocpp + ".o", "-march=rv64imafd", "-mabi=lp64d"]
