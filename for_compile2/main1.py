...
def compile_first_half(s):
    ...
    command3 = ["/home/sakakibara/opt3/bin/riscv64-unknown-elf-g++", "-c", filename_nocpp + ".cpp"]
    command3.append("-std=c++2a")
    command3.append("-static")
    command3.append("-g")
    command3.append("-O3")
    command3.append("-I")
    command3.append("/home/sakakibara/monte-carlo-ray-tracer_approx/lib/glm")
    command3.append("-I")
    command3.append("/home/sakakibara/monte-carlo-ray-tracer_approx/lib/nlohmann")
...
res = subprocess.run(command1, stdout=subprocess.PIPE, stderr=open("err_2_2.txt",'w'))
s = res.stdout.decode()
source_list = s.split('\n')
