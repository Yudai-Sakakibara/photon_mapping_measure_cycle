#include "linear-octree_SurfaceCentroid.hpp"
...
LinearOctree_SurfaceCentroid::LinearOctree_SurfaceCentroid(Octree_SurfaceCentroid &octree_root)
{
...
void LinearOctree_SurfaceCentroid::knnSearch(const glm::dvec3& p, size_t k, PriorityQueue<SearchResult_SurfaceCentroid>& result) const
{
    result.clear();
...
std::vector<SearchResult_SurfaceCentroid> LinearOctree_SurfaceCentroid::radiusSearch(const glm::dvec3& p, double radius) const
{
    std::vector<SearchResult_SurfaceCentroid> result;
...
void LinearOctree_SurfaceCentroid::octreeSize(const Octree_SurfaceCentroid &octree_root, size_t &size, size_t &data_size) const
{
...
BoundingBox LinearOctree_SurfaceCentroid::compact(Octree_SurfaceCentroid* node, uint32_t& df_idx, uint64_t& data_idx, uint64_t& contained_data, bool last)
{
    uint32_t idx = df_idx++;
